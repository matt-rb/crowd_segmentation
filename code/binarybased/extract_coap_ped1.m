...
load('variables/W_conv5_8bit_ped1');
load('variables/itq_8_conv5_ped1');
load('variables/bg_mask_ped1.mat');
feat_dir = '../data/ucsd_conv5/UCSDped1/Test';
img_folder = '../data/ucsd/UCSDped1/Test/Test001/';
options.gt_folder='../data/ucsd/UCSDped1/gt/';
options.segments_file=['../data/output/ped1/feats_conv5_th_' num2str(options.th) '_params.mat'];
